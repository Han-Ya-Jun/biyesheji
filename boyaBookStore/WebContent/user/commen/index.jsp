...
<link
	...
	rel="stylesheet">
<link
	href="${baseurl}assets/global/plugins/slider-layer-slider/css/layerslider.css"
	rel="stylesheet">
...
<link href="${baseurl}assets/frontend/pages/css/style-layer-slider.css"
	rel="stylesheet">
...
<body class="ecommerce">
					...
					<ul class="list-unstyled list-inline pull-right">
						<c:choose>
							<c:when test="${empty sessionScope.sessionUser }">
								<li><a
									href="${baseurl }loginfirst.action?url2=<c:url value='/jsps/user/regist.jsp'/>"><i
										class="fa fa-user-plus"></i>注册</a></li>
								<li><a
									href="${baseurl }loginfirst.action?url2=<c:url value='/jsps/user/login.jsp'/>"><i
										class="fa fa-user"></i>登陆</a></li>
							</c:when>
							<c:otherwise>
		                                                                               博雅会员：${sessionScope.sessionUser.loginname }&nbsp;&nbsp;|&nbsp;&nbsp;
		                        <li><a
									href="<c:url value='/loginfirst.action'/>?url2=<c:url value='/myCart.action'/>"><i
										class="fa fa-shopping-cart"></i>购物车</a></li>
								<li><a
									href="<c:url value='/loginfirst.action'/>?url2=<c:url value='/myorders.action'/>"><i
										class="fa fa-bitbucket-square"></i>博雅订单</a></li>
								<li><a data-toggle='modal' data-target='#mymodal'><i
										class="fa fa-edit"></i>修改密码</a></li>
	...
	<div class="header">
		<div class="container">
				...
				<ul>
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li class="dropdown-submenu"><a
								...
								onclick="serach3(this.name)">古典小说<i
									class="fa fa-angle-right"></i></a>
								<ul class="dropdown-menu" role="menu">
									<li><a name="<c:url value='/findByname.action'/>"
										onclick="serach3(this.name)">世界名著</a></li>
									<li><a name="<c:url value='/findByname.action'/>"
										onclick="serach3(this.name)">名人传记</a></li>
									<li class="dropdown-submenu"><a class="dropdown-toggle"
										...
										<ul class="dropdown-menu">
											<li><a name="<c:url value='/findByname.action'/>"
												onclick="serach3(this.name)">文学家</a></li>
											<li><a name="<c:url value='/findByname.action'/>"
												onclick="serach3(this.name)">科学家</a></li>
											<li><a name="<c:url value='/findByname.action'/>"
												onclick="serach3(this.name)">艺术家</a></li>
										</ul></li>
								</ul></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">政治人物</a></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">军事人物</a></li>
								...
								<div class="header-navigation-content">
									<div class="row">
										<div class="col-md-4 header-navigation-col">
											...
											<ul>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">幼儿认知</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">识字说话</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">智力启蒙</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">少儿国学</a></li>
											</ul>
										</div>
										<div class="col-md-4 header-navigation-col">
											<h4>科普百科</h4>
											<ul>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">百科全书</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">动物|植物</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">天文|地理</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">历史|文化</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">数理化|科技</a></li>
											</ul>
										</div>
										<div class="col-md-4 header-navigation-col">
											<h4>兴趣|爱好|特长</h4>
											<ul>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">音乐舞蹈</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">绘画书法</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">特长</a></li>
											</ul>

											<h4>卡通游乐园</h4>
											<ul>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">中国传统经典</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">梦幻迪斯尼</a></li>
												<li><a name="<c:url value='/findByname.action'/>"
													onclick="serach3(this.name)">甜美小公主</a></li>
											</ul>
										</div>
					...
					<li><a class="dropdown-toggle" data-toggle="dropdown"
						...
						<ul class="dropdown-menu">
							...
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">社会学</a></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">语言文学</a></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">文化</a></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">教育</a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">程序语言与软件开发</a></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">图像图像多媒体</a></li>
							<li><a name="<c:url value='/findByname.action'/>"
								onclick="serach3(this.name)">操作系统|系统开发</a></li>
							<li><a>办公与计算机</a></li>
						</ul></li>
					<li><a name="<c:url value='/user/commen/shop_about.jsp'/>"onclick="serach5(this.name)">关于博雅书城</a></li>
					<!-- BEGIN TOP SEARCH -->
					<li class="menu-search"><span class="sep"></span> <i
						...
						<div class="search-box">
							<form action="<c:url value='/findByname.action'/>" method="get"
								target="main" id="form1">
								<div class="input-group">
									<input type="text" placeholder="书籍名称" id="bname2"
										class="form-control"> <span class="input-group-btn">
										<button class="btn btn-primary"
											name="<c:url value='/findByname.action'/>"
											onclick="serach3(this.name)" type="button">搜索</button>
									</span>
								</div>
							</form>
						</div></li>
			...
			<input class="hidden" id="error" value="${msg }">
			<!-- END NAVIGATION -->
		</div>
	</div>
	<!-- Header END -->
	...
	<div class="page-slider margin-bottom-35">
		...
		<div id="layerslider"
			...
			<div class="ls-slide ls-slide1"
				...
				<img
					src="${baseurl}assets/frontend/pages/img/layerslider/slide1/bg.jpg"
          ...
          ">
			...
			<div class="ls-slide ls-slide2"
				...
				<img
					src="${baseurl}assets/frontend/pages/img/layerslider/slide2/bg.jpg"
					class="ls-bg" alt="Slide background">
          ...
          showuntil: 4000;
          ">
					<strong>系统架构</strong>高级并发编程<em>万亿级流量设计</em>
				</div>
          ...
          scaleout: .8;
          showuntil: 4000;">
					<b>特惠</b> <strong><span>￥</span>25</strong>
				</div>
          ...
          showuntil: 4000;">更多
			...
			<div class="ls-slide ls-slide3"
				...
				<img
					src="${baseurl}assets/frontend/pages/img/layerslider/slide3/bg.jpg"
					class="ls-bg" alt="Slide background">
          ...
          showuntil: 4000;
          ">
					读书节&amp; 购物狂欢 <strong>双十一</strong> 让我们疯狂起来吧！
				</div>
				<div class="ls-l"
          ...
          showuntil: 4000;
          ">
					<a href="javascript:;" class="ls-buy"> 机不可失! </a>
					<div class="ls-price">
						<span>全场所有商品:</span> <strong>6<sup>折</sup></strong>
					</div>
				</div>
			</div>
			<!-- slide three end -->
			...
			<div class="ls-slide ls-slide4"
				...
				<img
					src="${baseurl}assets/frontend/pages/img/layerslider/slide5/bg.jpg"
					class="ls-bg" alt="Slide background">
          ...
          scaleout: .8;
          showuntil: 4000;">
					<span> 书是人类进步的阶梯！</span> <a href="javascript:;">欢迎抢购！</a>
				</div>
				...
				<div class="col-md-12 sale-product">
					...
					<div class="owl-carousel owl-carousel5">
						...
						<c:forEach items="${newBook }" var="book">
							...
							<div>
								<div class="product-item" style="width: 218px; height: 306px;">
									<div class="pi-img-wrapper">
										<img style="height: 194px; width: 194px;"
											src="<c:url value='/${book.imageB }'/>"
											class="img-responsive" alt="${book.bname }">
										<div>
											<a href="<c:url value='/${book.imageW }'/>"
									...
									<h3 style="height: 46px;">
										<a  name="<c:url value='/findByname.action'/>?bname=${book.bname}"onclick="serach5(this.name)">${book.bname }</a>
									</h3>
									<div class="pi-price">￥${book.currprice }</div>
									<form action="<c:url value='/firstadd.action'/>" method="post">
										<input  class="hidden"id="product-quantity" type="text" value="1" name="quantity">
					...
					<ul class="list-group margin-bottom-25 sidebar-menu">
						<c:forEach items="${parents2}" var="parent">
							<li class="list-group-item clearfix dropdown"><a><i
									class="fa fa-angle-right"></i>${parent.cname}</a>
								<ul class="dropdown-menu">
									<c:forEach items="${parent.children}" var="child">

										<li><a
											href="/boyaBookStore/loginfirst.action?pid=${child.pid}&url2=<c:url value='/findByCategoryBook.action?cid=${child.cid}'/>"><i
												class="fa fa-angle-right"></i>${child.cname}</a></li>
									</c:forEach>
								</ul></li>
						</c:forEach>
						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<img
										src="${baseurl}assets/frontend/pages/img/index-sliders/slide1.jpg"
										class="img-responsive" alt="人名的名义">
								</div>
								<div class="item">
									<img
										src="${baseurl}assets/frontend/pages/img/index-sliders/slide2.jpg"
										class="img-responsive" alt="人名的名义">
								</div>
								<div class="item">
									<img
										src="${baseurl}assets/frontend/pages/img/index-sliders/slide3.jpg"
										class="img-responsive" alt="人名的名义">
								</div>
							</div>
						</div>
	...
	<!-- END FOOTER -->
	<c:forEach items="${newBook }" var="book">
		<!-- BEGIN fast 详情 of a product -->
		<div id="${book.bid }" style="display: none; width: 700px;">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-9">
						...
						<div class="product-page-cart">
							<form action="<c:url value='/firstadd.action'/>"
	...
	<!-- BEGIN LayerSlider -->
	<script
		src="${baseurl}assets/global/plugins/slider-layer-slider/js/greensock.js"
		type="text/javascript"></script>
	<!-- External libraries: GreenSock -->
	<script
		src="${baseurl}assets/global/plugins/slider-layer-slider/js/layerslider.transitions.js"
		type="text/javascript"></script>
	<!-- LayerSlider script files -->
	<script
		src="${baseurl}assets/global/plugins/slider-layer-slider/js/layerslider.kreaturamedia.jquery.js"
		type="text/javascript"></script>
	<!-- LayerSlider script files -->
	<script
		src="${baseurl}assets/frontend/pages/scripts/layerslider-init.js"
		type="text/javascript"></script>
	<!-- END LayerSlider -->
	...
	<script type="text/javascript">
		...
		function serach2(name) {
			...
			window.location.href = "/boyaBookStore/loginfirst.action?url2="
					+ url2;
		}
		function serach3(name) {
			var bname2 = $("#bname2").val();
			var url2 = name + "?bname=" + bname2;
			window.location.href = "/boyaBookStore/loginfirst.action?url2="
					+ url2;
		}
		function serach4(name) {
			...
			var url3 = name + "?press3=" + bname3;
			window.location.href = "/boyaBookStore/loginfirst.action?author="
					+ author3 + "&press=" + press3 + "&type=" + "combination"
					+ "&bname=" + bname3 + "&url2=" + url3;
		}
		function serach5(name) {
			
			window.location.href = "/boyaBookStore/loginfirst.action?url2="+name;
		}
		function jiesuan() {
			...
			window.location.href = "/boyaBookStore/loginfirst.action?cartItemIds="
					+ cartItemIds + "&total=" + total;
		}
	</script>
