...
<script type="text/javascript">
  ...
  <body style="margin-top: 114px;background-color: ccccff;">
	<div class="main">
	  
	  <div>
	    <div class="imageDiv"><img class="img" src="<c:url value='/images/zj.png'/>"/></div>
        <div class="login1" style="margin-left: 74px;">
	      <div class="login2">
            <div class="loginTopDiv">
              <span class="loginTop" style="color: #1192EF;font-size: 30px;font-weight: 900;margin-left: 96px;">博雅会员登录</span>
            
            </div>
            <div>
              <form  action="<c:url value='/login.action'/>" method="post" id="loginForm">
