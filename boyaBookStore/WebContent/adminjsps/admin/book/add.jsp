...
function loadChildren() {
	...
	*/
	...
	$.ajax({
		async:true,
		cache:false,
		url:"/boyaBookStore/ajaxFindChildren.action",
		data:{pid:pid},
		type:"POST",
		dataType:"json",
  ...
  <div>
   ...
   <form action="<c:url value='/AdminAddBook.action'/>" enctype="multipart/form-data" method="post" id="form">
    <div>
	    <ul>
	    	...
	    	<li>大图：　<input id="image_w" type="file" name="imageW"/></li>
	    	<li>小图：　<input id="image_b" type="file" name="imageB"/></li>
