 ...
 * 1. 对象名必须与第一个参数相同！
   2. 第二个参数是显示在菜单上的大标题
 */
var bar = new Q6MenuBar("bar", "博雅网上书城");
$(function() {
	...
	3. /boyaBookStore/jsps/book/list.jsp：点击二级分类后链接到的URL
	4. body:链接的内容在哪个框架页中显示
	*/
<c:forEach items="${parents}" var="parent">
  <c:forEach items="${parent.children}" var="child">
	bar.add("${parent.cname}", "${child.cname}", "/boyaBookStore/findByCategoryAdmin.action?cid=${child.cid}", "body");
  </c:forEach>
</c:forEach>
