...
<style type="text/css">
  ...
  <body>
    ...
    <form action="<c:url value='/editChild.action'/>" method="post" onsubmit="return checkForm()">
...
<c:forEach items="${parents }" var="parent">
    	...
    	分类描述：<textarea rows="5" cols="50" name="descrip" id="desc">${child.descrip }</textarea><br/>
