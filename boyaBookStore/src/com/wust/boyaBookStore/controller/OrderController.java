...
import com.wust.boyaBookStore.utils.PaymentUtil;
...
public class OrderController {
    ...
    public String back(HttpServletRequest req, HttpServletResponse resp)
         ...
         *   >如果校验失败：保存错误信息，转发到msg
         *   >如果校验通过：
         *     * 判断访问的方法是重定向还是点对点，如果要是重定向
         *     修改订单状态，保存成功信息，转发到msg
    ...
    public String phonepay(HttpServletRequest request, HttpServletResponse response) throws IOException{
        /**
         * 接收参数 创建订单
         */
        Properties props = new Properties();
        ...
        String codepay_id = props.getProperty("codepay_id");
      //  String token = props.getProperty("token");
        String return_url = props.getProperty("return_url");
        String notify_url = props.getProperty("notify_url");
       ...
       //  String codepay_id ="10590" ;//记得更改 http://codepay.fateqq.com 后台可获得
         ...
         String price=null; //表单提交的价格
         String type=request.getParameter("type"); //支付类型  1：支付宝 2：QQ钱包 3：微信
         String pay_id=user.getLoginname(); //支付人的唯一标识
         String param=request.getParameter("oid"); //自定义一些参数 支付后返回  
        // String notify_url="http://120.24.189.40:8088/boyaBookStore/notify.action";//通知地址
       
        // String return_url="http://120.24.189.40:8088/boyaBookStore/successjsp.action?oid="+oid;//支付后同步跳转地址
    ...
    public String notify(HttpServletRequest request, HttpServletResponse response) throws Exception{
        ...
        String key = props.getProperty("key");
         ...
         if(mySign.equals(sign)){ 
             ...
             String oid = request.getParameter("param"); 
    ...
    public String successjsp(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        req.setAttribute("code", "success");
        req.setAttribute("msg", "恭喜，支付成功！");
        return "jsps/msg";
